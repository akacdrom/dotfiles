...
theme.tasklist_bg_focus = "#1E1C2E"
theme.tasklist_bg_normal = "#0F0E17"
theme.tasklist_disable_icon = false
theme.tasklist_disable_task_name = false
theme.tasklist_fg_focus = "#ffffff"
theme.tasklist_fg_normal = "#555"
...
-- window switcher
theme.window_switcher_widget_bg = "#0F0E17" -- The bg color of the widget
...
theme.window_switcher_widget_border_color = "#0F0817" -- The border color of the widget
...
theme.window_switcher_name_normal_color = "#333333" -- The color of one title if the client is unfocused
theme.window_switcher_name_focus_color = "#ffffff" -- The color of one title if the client is focused
...
theme.task_preview_widget_bg = "#0F0E17" -- The bg color of the widget
...
theme.tag_preview_client_bg            = "#1E1C2E" -- The bg color of each client
theme.tag_preview_client_border_color  = "#0F0E17" -- The border color of each client
theme.tag_preview_client_border_width  = 0 -- The border width of each client
theme.tag_preview_widget_bg            = "#0F0E17" -- The bg color of the widget
theme.tag_preview_widget_border_color  = "#0F0E17" -- The border color of the widget
